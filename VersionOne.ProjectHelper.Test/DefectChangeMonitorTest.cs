...
{
    [TestClass]
    public class DefectChangeMonitorTest
    {
        [TestMethod]
        public void TestGetMostRecentChangedDateTime()
        {
            ...
            // And a new defect change monitor
            var monitor = new DefectChangeMonitor(instance.ApiClient.Services, instance.ApiClient.MetaModel);
